...
abstract public class BaseDynamicPluginManager extends BasePluginManager implements UuidManagerImpl {
    ...
    public InstalledApk getPlugin(String uuid, String partKey) throws FailedException, NotFoundException {
        try {
            ...
            Log.e("getPlugin", "partKey=" + partKey);
            try {
                part = getPluginPartByPartKey(uuid, partKey);
                Log.e("getPlugin", "partKey=" + part.toString());
                Log.e("getPlugin", "partKey=" + (part instanceof InstalledPlugin.PluginPart));
                Log.e("getPlugin", "partKey=" + (part instanceof InstalledPlugin.Part));
            ...
            Log.e("getPlugin", "businessName=" + businessName + "--dependsOn=" + dependsOn + "--hostWhiteList=" + hostWhiteList[0]);
